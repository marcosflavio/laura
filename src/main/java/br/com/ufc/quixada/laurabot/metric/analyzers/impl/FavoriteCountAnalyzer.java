...
import br.com.ufc.quixada.laurabot.metric.checkers.impl.FavoriteCountChecker;
import br.com.ufc.quixada.laurabot.metric.model.LauraAnswerMetric;

@Component
public class FavoriteCountAnalyzer implements AnswerAnalyzer {
	
	@Autowired
	private FavoriteCountChecker favoriteCountChecker;
